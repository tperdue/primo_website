...
$routes->get('quote', 'Quote::index', ['filter' => 'honeypot']);
...
$routes->group('admin', ['filter' => ['session', 'group:admin']], static function ($routes): void {
    ...
    $routes->get('quote-requests', 'Admin\QuoteRequests::index');
    $routes->get('quote-requests/(:num)', 'Admin\QuoteRequests::show/$1');
    $routes->post('quote-requests/(:num)', 'Admin\QuoteRequests::update/$1');
    $routes->get('quote-requests/(:num)/files/(:num)', 'Admin\QuoteRequests::download/$1/$2');
    $routes->post('quote-requests/(:num)/quote', 'Admin\Quotes::createFromRequest/$1');
    $routes->get('quotes', 'Admin\Quotes::index');
