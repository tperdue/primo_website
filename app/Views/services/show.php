    ...
    <main class="service-detail">
        ...
        <div class="service-detail-grid">
            ...
            <div class="service-detail-body">
                ...
                <div class="service-actions"><?php if (in_array((int) $service['id'], $quoteServiceIds, true)): ?><a class="button button-primary" href="/quote">Review quote <span aria-hidden="true">&nearr;</span></a><?php else: ?><form action="/quote/services/<?= (int) $service['id'] ?>" method="post"><?= csrf_field() ?><button class="button button-primary" type="submit">Add to quote <span aria-hidden="true">+</span></button></form><?php endif ?><?php if (isset($publicPages['contact'])): ?><a class="button button-outline" href="/contact">Ask a question <span aria-hidden="true">&nearr;</span></a><?php endif ?></div>
            </div>
        </div>
