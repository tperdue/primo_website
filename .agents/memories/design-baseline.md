...
- The media library is a dense thumbnail browser with usage information. Service pages support an uncropped featured image and related work; project pages support ordered two-column galleries that collapse to one column on mobile.
